  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <button
        ...
        className="w-full bg-[#F3F4F6] rounded-2xl px-4 py-3 text-[15px] text-[#1E1E1E] outline-none hover:bg-[#ECECEE] focus:bg-[#ECECEE] transition-colors flex items-center justify-between"
      >
